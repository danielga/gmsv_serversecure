...
elseif os.is("macosx") then
	print("WARNING: The only supported compilation platform (tested) for this project on Mac OSX is Xcode 4.1. However, any Xcode version *MIGHT* work as long as the Mac OSX 10.5 SDK is used (https://github.com/phracker/MacOSX-SDKs/releases/download/MacOSX10.11.sdk/MacOSX10.5.sdk.tar.xz).")

	newoption({
		trigger = "macosxsdk",
		description = "Sets the path to the Mac OSX 10.5 SDK (https://github.com/phracker/MacOSX-SDKs) directory",
		value = "path to Mac OSX 10.5 SDK directory"
	})
end
