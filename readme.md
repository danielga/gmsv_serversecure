...
The only supported compilation platform for this project on Windows is **Visual Studio 2017** on **release** mode. However, it's possible it'll work with *Visual Studio 2015*, *Visual Studio 2019*, *Visual Studio 2022*, and *Visual Studio 2026* because of the unified runtime.
